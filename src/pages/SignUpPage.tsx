      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Join DermAI UAE to start your skincare journey
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>I am a</Label>
              <RadioGroup value={role} onValueChange={(value) => setRole(value as 'user' | 'dermatologist')}>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="user" id="user" />
                  <Label htmlFor="user" className="font-normal cursor-pointer">
                    User (seeking skincare advice)
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="dermatologist" id="dermatologist" />
                  <Label htmlFor="dermatologist" className="font-normal cursor-pointer">
                    Dermatologist (providing consultations)
                  </Label>
                </div>
              </RadioGroup>
            </div>
